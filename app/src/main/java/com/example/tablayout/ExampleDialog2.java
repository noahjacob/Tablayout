...
public class ExampleDialog2 extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setView(view)
                .setTitle("Date And Location")
                .setNegativeButton("Outgoing", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        listener.applyTexts2(to, from,location);

                    }
                })

                .setPositiveButton("Incoming", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        int to = Integer.valueOf(TO.getText().toString());
                        String location = loc.getText().toString();
                        int from = Integer.valueOf(FROM.getText().toString());
                        listener = (ExampleDialogListener) getTargetFragment();
                        listener.applyTexts(to, from,location);
                    }
                });
    ...
    public interface ExampleDialogListener {
        void applyTexts(int to, int from,String location);
        void applyTexts2(int to, int from,String location);
    }
}

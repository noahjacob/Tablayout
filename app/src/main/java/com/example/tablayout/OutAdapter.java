...
public class OutAdapter extends FirestoreRecyclerAdapter<Initem,OutAdapter.itemholder> {
    /**
     ...
     * @param options
     */
    public OutAdapter(@NonNull FirestoreRecyclerOptions<Initem> options) {
        super(options);
    }
